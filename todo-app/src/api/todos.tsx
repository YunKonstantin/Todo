...
import type { Todo, TodosResponse, CreateTodoRequest, UpdateTodoRequest } from '../types/types';
...
export const todosApi = {
  ...
  fetchTodos: async (page: number, limit: number, filter: "active" | "completed" | "all"): Promise<TodosResponse> => {
    const params: any = { 
      _page: page, 
      _limit: limit,
      _sort: 'id',
